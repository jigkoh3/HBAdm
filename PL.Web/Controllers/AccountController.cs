...
namespace PL.Web.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        IRequestMemberService _adjustCriteriaService;
        public AccountController(IRequestMemberService adjustCriteriaService)
        {
            _adjustCriteriaService = adjustCriteriaService;
        }
        ...
        public async Task<UserInfoViewModel> GetUserInfo()
        {
            ...
            //userIdentity.Claims.Where(c => c.Type == ClaimTypes.Role).ToList().ForEach(claim => roles.Add(claim.Value));
            foreach (var itm in userIdentity.Claims.Where(c => c.Type == ClaimTypes.Role))
            {
                roles.Add(itm.Value);
            }
        ...
        public async Task<ManageInfoViewModel> GetManageInfo(string returnUrl, bool generateState = false)
        {
            ...
            {
                ModelState.AddModelError("returnUrl", "Canดt redirect to external urls");
        ...
        {
            var users = UnitOfwork.Repository<AppUserProfile>().Query().Get();
